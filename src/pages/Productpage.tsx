  ...
  return (
    <Layout>
      <div className="pt-[100px]">
        <aside className="grid grid-cols-2 gap-4 m-[2rem] ">
          <figure className=" min-h-[500px] grid grid-cols-[1fr_3fr] gap-4 ">
            <div className="flex flex-col h-[500px] gap-4">
              <aside className=" flex-1">
                <img src={oculus} className="h-full" alt="" />
              </aside>
              <aside className=" flex-1">
                <img src={oculus} className="h-full" alt="" />
              </aside>
              <aside className=" flex-1 ">
                <img src={oculus} className="h-full rounded-md" alt="" />
              </aside>
            </div>
            <div className="h-full ">
              <img src={oculus} className="h-[500px] object-cover w-full rounded-md" alt="" />
              <Button
          type="primary"
        ...
        >
         Add to Cart
          ...
          <figure className=" min-h-[50px] w-[90%] mx-auto">
